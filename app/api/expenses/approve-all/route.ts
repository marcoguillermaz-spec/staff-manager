...
export async function POST(request: Request) {
  ...
  const collaboratorIds = collabCommunities.map((r: { collaborator_id: string }) => r.collaborator_id);

  // Fetch all IN_ATTESA expenses for collaborators in this community
